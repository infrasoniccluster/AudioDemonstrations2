...
song6f = loadSound("Audio/6fSquareBurstMask.wav" );
song6f.setVolume(0.4);
...
button10b = createButton("Play");
button10b.parent("text12b");
button10b.mousePressed(toggleplay10b);
